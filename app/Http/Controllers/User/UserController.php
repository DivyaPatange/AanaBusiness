...
class UserController extends Controller
{
    ...
    public function success(Request $request)
    {
        ...
        $payment->save();
        $user_plan = UserPlan::where('user_id', $order->user_id)->update(['payment_status' => 'Successful']);
    ...
    public function treeview()
    {
        ...
        return view('user.treeview.index',compact('users','allMenus'));
    }
     ...
     public function wallet()
    {
        ...
        $allMenus = User::pluck('first_name','id', 'last_name', 'username')->all();
        return view('user.wallet.index', compact('users', 'allMenus', 'wallet', 'items2', 'items3', 'items4', 'items5', 'items6', 'items7'));
    }
