    ...
    <nav class="navbar navbar-static-top navbar-expand-lg">
        ...
        <ul class="nav navbar-nav">
            ...
            <button href="#" class="dropdown-toggle nav-link" data-toggle="dropdown">
                <img src="{{ asset('adminAsset/assets/img/user/user.png') }}" class="user-image" alt="User Image" />
                <span class="d-none d-lg-inline-block">{{ Auth::guard('admin')->user()->name }}</span>
            </button>
            <ul class="dropdown-menu dropdown-menu-right">
                <!-- User image -->
                <li class="dropdown-header">
                <img src="{{ asset('adminAsset/assets/img/user/user.png') }}" class="img-circle" alt="User Image" />
